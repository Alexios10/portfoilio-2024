        ...
        <div className="flex flex-col xl:flex-row items-center justify-between xl:pt-8 xl:pb-24">
          ...
          <div className="text-center xl:text-left order-2 xl:order-none">
            ...
            <h1 className="h1 mb-6">
              Hello I&apos;m <br />
              <span className="text-accent">Sattar</span>
            </h1>
            <p className="max-w-[500px] mb-9 text-white/80">
              Welcome to my portfolio, please have a look around and give me
              your thoughts and feedback in the contact page.
            </p>
            {/* btn and socials */}
            <div className="flex flex-col xl:flex-row items-center gap-8">
              <a
                href="/assets/Developer-Resume.pdf"
                download="/assets/Developer-Resume.pdf"
              >
                <Button
                  variant="outline"
                  size="lg"
